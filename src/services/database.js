...
(function() {
  var Firebase, Promise, R, Rx, addId, base, defaultTo, dot, getChild, getSnapshot, getStatus, getTeamId, getTeamRef, getUserBackDateTimeRef, getUserBackRef, getUserId, getUserRef, getUserStateRef, getUserStatusRef, getValue, getValueWithDefault, log, makeUserObject, message, method, ref1, setValue, snapshotToValue, teams;
  ...
  exports.getUserState(message).then(log);
